"""
Frost OS Module 02 — Database Engine & Session Factory.

Provides async SQLAlchemy engine, transactional session generator,
and table lifecycle management.
"""
...
async def create_tables() -> None:
    ...
    from app.models.mission import Base  # noqa: F401
    ...
    await logger.ainfo("Mission database tables created")
