"""
Frost OS Module 03 — Database Engine & Session Factory.

Provides async SQLAlchemy engine, transactional session generator,
and table lifecycle management for energy telemetry and state logs.
"""
...
async def create_tables() -> None:
    ...
    import app.models.energy_state  # noqa: F401 Ensure all tables are registered
    ...
    await logger.ainfo("Energy Intelligence database tables created")


async def drop_tables() -> None:
    """Drop all database tables (for testing/reset)."""
    from app.models.telemetry import Base
    import app.models.energy_state  # noqa: F401
